...
import {PropsCreateFuturePriceTag} from './interfaces';
import styles from './CreateFuturePriceTag.module.scss';
...
function CreateFuturePriceTag({}: PropsCreateFuturePriceTag) {
...
export default CreateFuturePriceTag;
